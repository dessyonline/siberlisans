    ...
    handlers: {
      GET: async () => {
        const staticEntries: SitemapEntry[] = [
          ...
          { path: "/paketler", changefreq: "weekly", priority: "0.8" },
          { path: "/paketler/ai", changefreq: "weekly", priority: "0.8" },
          { path: "/cekilis", changefreq: "daily", priority: "0.7" },
          { path: "/liderlik", changefreq: "daily", priority: "0.6" },
          { path: "/bayilik", changefreq: "monthly", priority: "0.6" },
          { path: "/karsilastir", changefreq: "weekly", priority: "0.6" },
