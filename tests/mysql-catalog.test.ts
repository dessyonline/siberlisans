...
afterEach(() => {
  ...
  if (oldUrl === undefined) delete process.env.EXT_SUPABASE_URL; else process.env.EXT_SUPABASE_URL = oldUrl;
  if (oldToken === undefined) delete process.env.EXT_SUPABASE_SERVICE_ROLE_KEY; else process.env.EXT_SUPABASE_SERVICE_ROLE_KEY = oldToken;
});
